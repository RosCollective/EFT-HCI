...
CHAPTER 10 — ECOLOGICAL QUANTIZATION & HYBRID OPERATOR FIELDS
(Style A — High-Density Theoretical)

====================================================================
10.1 — OPERATOR LIFTING OF ECOLOGICAL FIELDS
====================================================================
...
Non-Abelian constraint algebra:
    ...
    [Λ_{μν}, Λ_{αβ}] = i(Λ_{μ[α} δ_{β]ν} − Λ_{ν[α} δ_{β]μ})
